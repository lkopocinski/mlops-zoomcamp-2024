...
reference_data = pd.read_parquet('../../data/processed/05-monitoring/reference.parquet')
with open('models/lin_reg.bin', 'rb') as f_in:
	model = joblib.load(f_in)

raw_data = pd.read_parquet('../../data/raw/05-monitoring/green_tripdata_2024-03.parquet')
